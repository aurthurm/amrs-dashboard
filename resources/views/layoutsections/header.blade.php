...
<link href="{{ url('//fonts.googleapis.com/css?family=Hind+Vadodara:400,500,600', []) }}" rel="stylesheet">
...
<link href="{{ asset ('assets/vendor/toggle/bootstrap4-toggle.min.css') }}" rel="stylesheet">
